                        ...
                        <div class="card-body">
                            ...
                            <div id="adm_chk_box">
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="adm_new_token">Open Ticket</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="AdmCHKOption" id="adm_pre_token">
                                    <label class="form-check-label" for="adm_pre_token">Closed Ticket</label>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                @foreach ($getTicket as $tl)
                                                    <tr>
                                                        ...
                                                        <td><button type="button" class="BtnUSR btn btn-link" style="margin-top:-7px;" uid="{{$tl->userID}}" subTitle="{{$tl->subject}}">{{$tl->custNm}}</button></td>
                                                        <td>{{$tl->subject}}</td>
